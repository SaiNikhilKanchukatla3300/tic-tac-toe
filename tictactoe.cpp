...
void shape()
{
    ...
    if(i%2==0)
        ...
        switch(t)
        {
            case 1:if(check[0][0]==1) {printf("already filled,please select another block"); i--;} 
                   else {arr[0][0]=x; check[0][0]=1;}
                   break;
            case 2:if(check[0][1]==1) {printf("already filled,please select another block"); i--;} 
                   else {arr[0][1]=x; check[0][1]=1;}
                   break;
            case 3:if(check[0][2]==1){ printf("already filled,please select another block"); i--;}
                   else {arr[0][2]=x; check[0][2]=1;}
                   break;
            case 4:if(check[1][0]==1) {printf("already filled,please select another block"); i--;} 
                    else {arr[1][0]=x; check[1][0]=1;}
                    break;
            case 5:if(check[1][1]==1) {printf("already filled,please select another block"); i--;}
                   else {arr[1][1]=x; check[1][1]=1;}
                   break;
            case 6:if(check[1][2]==1) {printf("already filled,please select another block"); i--;}
                   else {arr[1][2]=x; check[1][2]=1;}
                   break;
            case 7:if(check[2][0]==1) {printf("already filled,please select another block"); i--;}
                   else {arr[2][0]=x; check[2][0]=1;}
                   break;
            case 8:if(check[2][1]==1) {printf("already filled,please select another block"); i--;}
                   else {arr[2][1]=x; check[2][1]=1;}
                   break;
            case 9:if(check[2][2]==1) {printf("already filled,please select another block"); i--;}
                   else {arr[2][2]=x; check[2][2]=1;}
                   break;
        }
        system("cls");
        shape1();
